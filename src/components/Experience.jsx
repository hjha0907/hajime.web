  ...
  return (
    ...
    <div className='text-center'>
        ...
        <div className='text-left'>
            <div className='w-[80%] md:w-[50%] mx-auto mt-8 reveal'><i class="fa-solid fa-graduation-cap"/> Education</div>
            <div className='border-l-4 pl-4 w-[80%] md:w-[50%] mx-auto reveal'>
            ...
            <div className='w-[80%] md:w-[50%] mx-auto mt-8 reveal'><i class="fa-solid fa-briefcase"/> Career history</div>
            <div className='border-l-4 pl-4 w-[80%] md:w-[50%] mx-auto reveal'>
            ...
            <div className='w-[80%] md:w-[50%] mx-auto mt-8 reveal'><i class="fa-solid fa-briefcase"/> Freelance</div>
            <div className='border-l-4 pl-4 w-[80%] md:w-[50%] mx-auto reveal'>
