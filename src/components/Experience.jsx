  ...
  return (
    ...
    <div className='text-center'>
        ...
        <div className='text-left'>
            <div className='w-[50%] mx-auto mt-8'><i class="fa-solid fa-graduation-cap"/> Education</div>
            <div className='border-l-4 pl-4 w-[50%] mx-auto'>
            ...
            <div className='w-[50%] mx-auto mt-8'><i class="fa-solid fa-briefcase"/> Career history</div>
            <div className='border-l-4 pl-4 w-[50%] mx-auto'>
            ...
            <div className='w-[50%] mx-auto mt-8'><i class="fa-solid fa-briefcase"/> Freelance</div>
            <div className='border-l-4 pl-4 w-[50%] mx-auto'>
